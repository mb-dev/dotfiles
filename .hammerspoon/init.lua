...
hs.hotkey.bind(mash, 'Left', function() hs.window.focusedWindow():moveToUnit(units.left50) end)
hs.hotkey.bind(mash, 'Right', function() hs.window.focusedWindow():moveToUnit(units.right50) end)
